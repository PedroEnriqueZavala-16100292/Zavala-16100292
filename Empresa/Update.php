<?php
	...
	if(isset($_POST['Guardar']))
	{
		...
		//modificar centro
		$consulta_update1=$connection->prepare('UPDATE centro SET  
		nombre=:nombre,
		direccion=:direccion,
		sucursal=:sucursal,
		saldo=:saldo,
		...
		$consulta_update1->execute(array(
		':clave'=>$clave,
		':nombre'=>$nombre,
		':direccion'=>$direccion,
		':sucursal'=>$sucursal,
		...
		//modificar aduana
		$consulta_update2=$connection->prepare('UPDATE aduana SET  
		nombre=:nombre,
		direccion=:direccion,
		sucursal=:sucursal,
		saldo=:saldo,
	...
	//modificar FV1
	$consulta_update3=$connection->prepare('UPDATE fv1 SET  
		nombre=:nombre,
		direccion=:direccion,
		sucursal=:sucursal
		WHERE clave=:clave;'
		);
		$consulta_update3->execute(array(
		':clave'=>$clave,
		':nombre'=>$nombre,
		':direccion'=>$direccion,
		':sucursal'=>$sucursal
		...
		//modificar FV2
		$consulta_update4=$connection->prepare('UPDATE fv2 SET  
		saldo=:saldo,
		codigo_postal=:codigo_postal,
		rfc=:rfc
		WHERE clave=:clave;'
		);
		$consulta_update4->execute(array(
		':clave'=>$clave,
		':saldo'=>$saldo,
		':codigo_postal'=>$codigo_postal,
		':rfc'=>$rfc
    ...
    <form class="formulario" method="post">
		...
		<div class="contenedor">
			...
			<div class ="input-contenedor">	
				...
				<input type="text" name="sucursal" value="<?php if($resultado) echo $resultado['sucursal']; ?>" class="input__text" disabled>
			</div>
